...
Это важно понимать: stage 3 уже не только описан в архитектуре, а материализован как рабочий контракт между .NET и отдельным embedding-сервисом. При этом stage 4 ещё не включён, поэтому чанки пока не индексируются в Qdrant автоматически.
