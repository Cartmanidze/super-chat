...
public static class ServiceCollectionExtensions
{
        ...
        bool enableBackgroundWorkers = true)
    {
        ...
        services.AddSingleton<ExtractedItemIngestionService>();
        services.AddSingleton<ExtractedItemAutoResolutionService>();
        services.AddSingleton<ExtractedItemLookupService>();
        services.AddSingleton<ExtractedItemQueryService>();
        services.AddSingleton<ExtractedItemManualResolutionService>();
        ...
        services.AddSingleton<IWorkItemActionService, WorkItemActionService>();
